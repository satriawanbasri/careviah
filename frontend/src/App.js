...
export default () => {
    ...
    const [completedServiceId, setCompletedServiceId] = useState(null)

    return (
        <>
            <CompletedServiceIdContext.Provider value={{ completedServiceId, setCompletedServiceId }}>
            ...
            </CompletedServiceIdContext.Provider>
        </>
    )
}
